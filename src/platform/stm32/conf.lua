...
specific_files = "core_cm3.c system_stm32f10x.c startup_stm32f10x_hd.s platform.c stm32f10x_it.c lcd.c lua_lcd.c platform_int.c enc.c fsmc_sram.c sdcard.c diskio_sdio_stm32.c fsmc_nand.c nand_if.c snd.c"
