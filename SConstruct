...
if not GetOption( 'help' ):
  ...
  if comp['allocator'] == 'auto':
    if comp['board'] in ['LPC-H2888', 'ATEVK1100', 'MBED', 'MIZAR32', 'STM3210E-EVAL']:
  ...
  # Application files
  app_files = " src/main.c src/romfs.c src/semifs.c src/xmodem.c src/shell.c src/common.c src/buf.c src/elua_adc.c src/dlmalloc.c src/salloc.c src/luarpc_elua_uart.c src/elua_int.c src/vram.c src/term_vram.c "
